...
describe('Rminder', () => {
  ...
  describe.skip('Rminder.tasks', () => {
    it('Should add task', () => {
      ...
      expect(rminder.taskList.innerHTML).equals(
        '<vp-list-task title="test" task="1" complete="false" important="false" order="0"></vp-list-task>'
      );
    ...
    it('Should add completed task', () => {
      ...
      expect(rminder.taskList.innerHTML).equals(
        '<vp-list-task title="test" task="1" complete="true" important="false" order="0"></vp-list-task>'
      );
    ...
    it('Should add important task', () => {
      ...
      expect(rminder.taskList.innerHTML).equals(
        '<vp-list-task title="test" task="1" complete="false" important="true" order="0"></vp-list-task>'
      );
    ...
    it('Should add completed and important task', () => {
      ...
      expect(rminder.taskList.innerHTML).equals(
        '<vp-list-task title="test" task="1" complete="true" important="true" order="0"></vp-list-task>'
      );
      expect(rminder.listImportant.getAttribute('count')).equals('1');
    ...
    it('Should add task to specific list', () => {
      ...
      expect(rminder.taskList.innerHTML).equals(
        '<vp-list-task title="test2" task="2" complete="false" important="true" order="0"></vp-list-task>'
      );
  ...
  describe('Rminder.details', () => {
    it('Should fill details info', () => {
      ...
      expect(rminder.detailsContainer.getAttribute('aria-label')).equals(
        'Detail for task: test'
      );
      ...
      expect(rminder.creationDate.innerText).equals(
        new Intl.DateTimeFormat().format(new Date(1616785736469))
      );
  ...
  describe.skip('Rminder.addTask', () => {
    ...
    it('Should not send postMessage if title is missing', () => {
      ...
      td.verify(console.log('Required field(s) missing: title', []), {
        times: 1,
      });
    });
  });

  describe.skip('Rminder.renameTask', () => {
  ...
  describe.skip('Rminder.showDetails', () => {
    it('Should send postMessage to show details', () => {
      ...
      expect(rminder.detailsContainer.classList.contains('expanded')).to.be
        .false;
  ...
  describe.skip('Rminder.hideDetails', () => {
  ...
  describe.skip('Rminder.toggleSidebar', () => {
  ...
  describe.skip('Rminder.hideSidebar', () => {
  ...
  describe.skip('Rminder.handleEvent', () => {
  ...
  describe.skip('Rminder.setTaskNote', () => {
  ...
  describe('Rminder.setDetailClasses', () => {
    it('Should set classes when data is an array', () => {
      ...
      expect(rminder.detailsContainer.classList.contains('important')).to.be
        .true;
      expect(rminder.detailsContainer.classList.contains('completed')).to.be
        .true;
  ...
  describe.skip('Rminder.setDetailClasses', () => {
  ...
  describe.skip('Rminder.setSelected', () => {
  ...
  describe.skip('Rminder.settingsCompleted', () => {
    it('Should postMessage with completed true', () => {
      ...
      td.verify(
        db.postMessage({ type: 'settings', completed: true, list: '' })
      );
    });
    it('Should postMessage with completed false', () => {
      ...
      td.verify(
        db.postMessage({ type: 'settings', completed: false, list: '' })
      );
    });
  });
  ...
  describe.skip('Rminder.settings', () => {
  ...
  describe.skip('Rminder.filterUpdate', () => {
    let db;
  ...
  describe.skip('Rminder.addEventListeners', () => {
    let db;
    ...
    it('Should call renameTask on keyup', () => {
      ...
      rminder.titleInput.dispatchEvent(
    ...
    it('Should call addTask on keyup', () => {
      ...
      rminder.taskInput.dispatchEvent(
        new KeyboardEvent('keyup', { key: 'Enter', code: 'Enter' })
      );
